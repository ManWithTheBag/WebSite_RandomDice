...
function getRundomDicePath() {
  ...
  var rundomImgPath = "images/dice" + runsomNumber + ".png";
...
function createPlayerHtml() {
  var htmlDiv = $("<div class='col-4 _dice-centr js-player'>  <h3 class='js-player-number'>Player 1</h3>   <img class='_dice-image js-dice-img' src='images/dice6.png' alt='dice image'>   </div>")
